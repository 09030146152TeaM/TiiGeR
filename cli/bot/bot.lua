...
chats = {}
plugins = {}
TiGeR_sudo = 205549111 -- ایدی سودوی اصلی را قرار دهید
GpsidSudo = -1001216848131
bot_id = 502774533 -- ایدی ربات را قرار دهید
helper_id = 553983788 -- ایدی ربات api را قرار دهید
TiGeRwmch = '@TIGERTEM' -- یوزرنیم کانال خود را قرار دهید
TiGeRwmby = '@Arashwm' -- یوزرنیم خود را قرار دهید
TiGeRwmbybot = '@Pvresanforoshbot'  -- یوزرنیم پیام رسان خود را قرار دهید
paypinglink = 'arashwm' -- لینک payping  خود را قرار دهید
paypingname = 'arash wm' -- اسم خود را وارد نماید
...
function create_config( )
  -- A simple config with basic plugins and ourselves as privileged user
   ...
   "Videonote"
    ...
    sudo_users = {553983788,502774533,205549111}, -- در اینجا آیدی ربات api و cli  و سودو ها را وارد کنید
    admins = {},
    disabled_channels = {},
