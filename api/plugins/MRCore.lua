...
local settings = data[tostring(GP_id)]["settings"]
 text = '*به تنظیمات پیام های مکرر خوش آمدید* 🤖'
	...
	keyboard.inline_keyboard = {
		{
			{text = '✦ حداکثر پیام های مکرر ♻️', callback_data = 'TiGeRTeM'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="TiGeRTeM"},
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '✦ حداکثر حروف مجاز 📜', callback_data = 'TiGeRTeM'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="TiGeRTeM"},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '✦ زمان بررسی پیام های مکرر 🎴', callback_data = 'TiGeRTeM'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="TiGeRTeM"},
...
text = "به پنل شیشه‌ای مدیریتی گروه خوش آمدید 🌹\nبرای مدیریت گروه میتونید از دکمه های زیر استفاده کنید...\n\nبرای حمایت از ما لطفا به ما رای دهید ❤️"
	...
	keyboard.inline_keyboard = {
	    {
            {text = "❤️ "..tostring(redis:get("TiiGeRLikes")), callback_data="/like:"..GP_id},
            {text = "💔 "..tostring(redis:get("TiiGeRDisLikes")), callback_data="/dislike:"..GP_id}
        },
        {
...
-- شرط ولکام
 ...
 if(mute_photo=="yes")then mute_photo_text = "فعال✅"elseif(mute_photo=="kick")then mute_photo_text = "حالت اخراج📛"elseif(mute_photo=="no")then mute_photo_text = "غیرفعال❌"elseif(mute_photo=="warn")then mute_photo_text = "حالت اخطار🚷"end
	...
	keyboard.inline_keyboard = {
		{
			{text = "✦ قفل ویرایش ✏️: "..lock_edit_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل لینک 📎: "..lock_link_text.."", callback_data='TiGeRTeM'}
		},
		{
		...
		{
			{text = "✦ قفل تگ #️⃣ : "..lock_tag_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل نام کاربری 🆔:"..lock_username_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل فراخوانی ⚠️: "..lock_mention_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل عربی 🔠: "..lock_arabic_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل انگلیسی 🔠: "..lock_english_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل صفحات وب 🌐: "..lock_webpage_text.."", callback_data='TiGeRTeM'}, 
		},
		{
		...
		{
			{text = "✦ قفل فونت 💱: "..lock_markdown_text.."", callback_data='TiGeRTeM'}, 
		},
		{
		...
		{
			{text = "✦ قفل تصاویر متحرک 🎇: "..mute_gif_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل متن 🔤: "..mute_text_text.."", callback_data='TiGeRTeM'}  
		},
		{
		...
		{
			{text = "✦ قفل اینلاین ✨: "..mute_inline_text.."", callback_data='TiGeRTeM'}, 
		},
		{
		...
		{
			{text = "✦ قفل بازی 🎮: "..mute_game_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل عکس 🌄: "..mute_photo_text.."", callback_data='TiGeRTeM'}  
		},
		{
...
function mutelists(msg, data, GP_id) 
   ...
   if mutes.mute_document then
	...
	keyboard.inline_keyboard = {
		{
		{text = "✦ قفل فیلم 🎥: "..mute_video_text.."", callback_data='TiGeRTeM'}
		},
		{
		...
		{
		{text = "✦ قفل فیلم سلفی 🎥: "..mute_video_self_text.."", callback_data='TiGeRTeM'}
		},
		{
		...
		{
			{text = "✦ قفل آهنگ 🎵: "..mute_audio_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل ویس 🎙: "..mute_voice_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل استیکر 🔰: "..mute_sticker_text.."", callback_data='TiGeRTeM'}
		},
		{
		...
		{
			{text = "✦ قفل مخاطب ☎️: "..mute_contact_text.."", callback_data='TiGeRTeM'}
		},
		{
		...
		{
			{text = "✦ قفل نقل قول 🔗: "..mute_forward_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل مکان 📡: "..mute_location_text.."", callback_data='TiGeRTeM'} 
		},
		{
		...
		{
			{text = "✦ قفل فایل 📂: "..mute_document_text.."", callback_data='TiGeRTeM'}  
		},
		{
		...
		{
			{text = "✦ قفل کیبورد 🎹: "..mute_keyboard_text.."", callback_data='TiGeRTeM'} 
		},
		{
...
local chatid = "-"..msg.query:match("%d+")
	...
	keyboard.inline_keyboard = {
	    {
            {text = "❤️ "..tostring(redis:get("TiiGeRLikes")), callback_data="/like:"..chatid},
            {text = "💔 "..tostring(redis:get("TiiGeRDisLikes")), callback_data="/dislike:"..chatid}
        },
        {
...
options(msg, matches[2])
  ...
  if matches[1] == '/like' then
      if redis:get("IsDisLiked:"..msg.from.id) then
        ...
        local dislikes = redis:get("TiiGeRDisLikes")
        redis:set("TiGeRDisLikes",dislikes - 1)
        redis:set("IsLiked:"..msg.from.id,true)
        local likes = redis:get("TiiGeRLikes")
        redis:set("TiiGeRLikes",likes + 1)
  ...
  if matches[1] == '/dislike' then
      if redis:get("IsLiked:"..msg.from.id) then
        ...
        local dislikes = redis:get("TiiGeRDisLikes")
        redis:set("TiiGeRDisLikes",dislikes + 1)
...
🆔 : ]]
    ...
    edit_inline(msg.message_id, text..TiGeRwmch, keyboard)
end
end
